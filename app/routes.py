...
def index():
    ...
    if form.login.is_submitted() and form.login.submit.data:
        if not form.login.validate_on_submit():
            ...
            sql = query_db('SELECT * FROM Users WHERE username="{}";'.format(form.login.username.data), one=True) # Finds information about the name you wrote in the "Username" field of the Login form
